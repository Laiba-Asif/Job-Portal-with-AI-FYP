  ...
  function onSubmit(values: z.infer<typeof FormSchema>) {
    ...
    mutate(data, {
      onSuccess: (response: any) => {
        ...
        //   queryKey: ["authUser"],
        // });
        refetch(); // refreshes or refetch the user in auth-provider
        setIsOpen(false);
        toast({
          title: "Success",
          ...
          <Dialog modal open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="!gap-0">
              ...
              <div className="">
                ...
                <p className="mt-2 text-xs text-slate-600 dark:text-gray-300 italic">
                  After enabling MFA, you’ll need to open your authenticator app
                  (Google Authenticator, 1Password, Authy, etc.) every time you
                  log in. It will generate a 6-digit code you must enter.
                </p>
              </div>
